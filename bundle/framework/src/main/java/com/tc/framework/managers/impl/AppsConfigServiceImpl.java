...
@Properties({
    @Property(name = "service.pid", value = "org.virtusa.launchpad.framework.api.AppsConfigService", propertyPrivate = false),
...
public class AppsConfigServiceImpl implements AppsConfigService {
     ...
     */
    private static final Logger LOG = LoggerFactory.getLogger(AppsConfigServiceImpl.class);
    /**
     * period.
     */
     ...
     * @param locale the locale
     * @param key the key
     * @param mockValues mock value map
     * @return the property
     */
    public String getProperty(Locale locale, String key,
    ...
    public final String getProperty(final String key) {
        ...
        } catch (GenericFrameworkException e1) {
            LOG
                    .error(
     ...
     *
     * @param htmlContent - The html content to be transformed.
     ...
     *
     * @param value - The local string to check.
     * @return - true/false.
     */
     ...
     *
     * @return the session
     * @throws GenericFrameworkException the application exception
     */
    protected final Session getSession() throws GenericFrameworkException {
        ...
        try {
            ...
            throw new GenericFrameworkException("Error in getSession of BaseManagerImpl",
                    re);
     ...
     * Bind repository.
     *
     * @param repo the SlingRepository
     */
    ...
    public void saveProperty(AppsConfigBean appsconfigBean, String path)
        ...
        try {
            ...
            throw new GenericFrameworkException("Error while saving appsConfignode", e);
        }
    ...
    public List<AppsConfigBean> getAllProperties(String path, Session session)
        ...
        try {
            ...
            throw new GenericFrameworkException("Error while retreiving appsconfig", e);
        }
