...
@SlingServlet(paths = {"/bin/services/appsConfigServlet"}, methods = {"GET", "POST"}, metatype = true)
@Properties({
    @Property(name = "service.pid", value = "org.virtusa.launchpad.servlet.AppsConfigServlet", propertyPrivate = false)})
public class AppsConfigServlet extends BaseSlingServlet {
     ...
     * The Constant LOG.
     */
    private static final Logger LOG = LoggerFactory.getLogger(AppsConfigServlet.class);
