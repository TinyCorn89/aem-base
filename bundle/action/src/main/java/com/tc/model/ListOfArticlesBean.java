 ...
 * @author gdinakar
 */
public class ListOfArticlesBean implements Serializable {
	...
	private List<LatestArticlesBean> listOfLatestArticles;
	 ...
	 */
	public List<LatestArticlesBean> getListOfLatestArticles() {
	...
	public void setListOfLatestArticles(
			List<LatestArticlesBean> listOfLatestArticles) {
	...
	public boolean equals(Object obj) {
		...
		ListOfArticlesBean other = (ListOfArticlesBean) obj;
