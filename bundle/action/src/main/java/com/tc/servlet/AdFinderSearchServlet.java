...
public class AdFinderSearchServlet extends BaseSlingServlet {
	...
	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(AdFinderSearchServlet.class);
	 ...
	 protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException {
		 ...
		 LOG.info(" request.getParameter==="+ request.getParameter("advertiserId"));
		 request.setAttribute("advertiserId", request.getParameter("advertiserId"));
