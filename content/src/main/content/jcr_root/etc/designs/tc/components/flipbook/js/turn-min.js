    ...
    var x, y = "",
        ...
        g = {
            ...
            size: function (a, b) {
                if (a && b) {
                    ...
                    for (e in c.pageWrap) p(e, c.pageWrap) && (c.pageObjs[e].css({
                        width: d,
                        height: b
                    }), c.pageWrap[e].css({
                        width: d,
            ...
            update: function () {
                ...
                if (b.pageMv.length && 0 !== b.pageMv[0]) {
                    ...
                    for (a in b.pageWrap) p(a, b.pageWrap) && (b.pageWrap[a].css({
        ...
        i = {
            ...
            _backGradient: function () {
                var a = this.data().f,
                    b = a.opts.turn;
                if ((b = a.opts.backGradient && (!b || "single" == b.data().display || 2 != a.opts.page && a.opts.page != b.data().totalPages - 1)) && !a.bshadow) a.bshadow = h("<div/>", l(0, 0, 1)).css({
                    position: "",
                    width: this.width(),
                    height: this.height()
                }).appendTo(a.parent);
            ...
            _moveFoldingPage: function (a) {
                ...
                if (c)
                    if (a) {
                        if (!b.fpage.children()[b.ashadow ? "1" : "0"]) i.setData.call(this, {
                            backParent: c.parent()
                        }), b.fpage.prepend(c)
