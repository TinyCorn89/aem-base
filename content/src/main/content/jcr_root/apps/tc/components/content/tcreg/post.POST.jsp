...
%><sling:defineObjects/><%
    ...
    if (shouldProcessRequest) {
        ...
        try {
            ...
            //final String  unis = request.getParameter("unis")==null? null : slingRequest.getRequestParameter("unis").getString();
             final String []  mailList = request.getParameterValues("mailList");
            ...
            if (error==null) {
                ...
                try {
                    ...
                    //service.subscribe(auth,"UNIS List 1");
